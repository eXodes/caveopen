...
B4|2026-06-29|`/caveman-stats` hook ⊥ `synthetic:true` blocker (⊥ `/ck:init` pattern) → model runs post-hook → processes stale `caveman-stats.md` (wrong schema, wrong default scope "lifetime" vs hook "session") → double output.|V30
